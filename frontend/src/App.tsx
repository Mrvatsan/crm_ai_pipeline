      ...
      <header className="bg-white/80 backdrop-blur-xl border-b border-emerald-100 px-6 py-4 flex items-center justify-between sticky top-0 z-40 h-16 shadow-sm">
        ...
        <div className="flex items-center gap-5">
          ...
          <button
            ...
            className={`p-1.5 rounded-lg border transition-all ${showSettings
                  ...
                  projects.map((proj) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left p-3 rounded-xl border text-xs flex flex-col gap-1 transition-all ${isActive
                  ...
                  <div className="space-y-6">
                    {messages.map((msg) => {
                      ...
                      return (
                        ...
                        >
                          {/* Avatar bubbles */}
                          <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm ${isUser
                          ...
                          <div className="flex flex-col gap-2.5 flex-1 max-w-[85%]">
                            <div className={`p-4 rounded-xl text-xs leading-relaxed shadow-sm ${isUser
            ...
            <div className="flex border-b border-slate-200 pb-1.5 gap-3.5 items-center justify-between">
              <div className="flex gap-3.5">
                <button
                  ...
                  className={`pb-2 font-black text-[10px] uppercase tracking-widest transition-all ${activeTab === "preview"
                ...
                <button
                  ...
                  className={`pb-2 font-black text-[10px] uppercase tracking-widest transition-all ${activeTab === "schema"
                      ? "text-indigo-600 border-b border-indigo-400"
                      : "text-slate-500 hover:text-slate-500"
                    }`}
                >
                  ...
                  <div className="flex bg-white border border-slate-200 p-1 rounded-xl w-fit gap-1 text-[9px] font-black uppercase tracking-wider shadow-inner">
                    {(["ui", "api", "db", "auth"] as const).map((tab) => (
                      <button
                        ...
                        className={`px-2.5 py-1.5 rounded-lg transition-all ${activeSchemaTab === tab
